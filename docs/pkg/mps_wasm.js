...
export class PhysicsWorld {
     ...
     * @param {boolean} wake
     */
    add_force(h, fx, fy, fz, wake) {
        wasm.physicsworld_add_force(this.__wbg_ptr, h, fx, fy, fz, wake);
    }
    /**
     * @param {bigint} h
     * @param {number} tx
     ...
     * @param {boolean} wake
     */
    add_torque(h, tx, ty, tz, wake) {
        wasm.physicsworld_add_torque(this.__wbg_ptr, h, tx, ty, tz, wake);
    }
    /**
     * @param {bigint} h
     * @param {number} ix
     ...
     * @param {boolean} wake
     */
    apply_impulse(h, ix, iy, iz, wake) {
        wasm.physicsworld_apply_impulse(this.__wbg_ptr, h, ix, iy, iz, wake);
    }
    clear_events() {
     ...
     * @returns {bigint}
     */
    create_dynamic_sphere(px, py, pz, r, mass) {
        const ret = wasm.physicsworld_create_dynamic_sphere(this.__wbg_ptr, px, py, pz, r, mass);
        return BigInt.asUintN(64, ret);
    }
    /**
     * @param {number} nx
     ...
     * @returns {Vec3}
     */
    get_body_angular_velocity(h) {
        const ret = wasm.physicsworld_get_body_angular_velocity(this.__wbg_ptr, h);
        return Vec3.__wrap(ret);
    }
    /**
     * @returns {number}
     ...
     * @returns {Vec3}
     */
    get_body_linear_velocity(h) {
        const ret = wasm.physicsworld_get_body_linear_velocity(this.__wbg_ptr, h);
        return Vec3.__wrap(ret);
    }
    /**
     * @param {bigint} h
     ...
     */
    get_body_rotation(h) {
        const ret = wasm.physicsworld_get_body_rotation(this.__wbg_ptr, h);
        return Quat.__wrap(ret);
    }
    /**
     ...
     * @returns {Vec3}
     */
    get_body_translation(h) {
        const ret = wasm.physicsworld_get_body_translation(this.__wbg_ptr, h);
        return Vec3.__wrap(ret);
    }
    /**
     ...
     * @returns {bigint}
     */
    insert_collider(desc, parent) {
        _assertClass(desc, ColliderDescriptor);
        const ret = wasm.physicsworld_insert_collider(this.__wbg_ptr, desc.__wbg_ptr, parent);
        return BigInt.asUintN(64, ret);
    }
    /**
     ...
     */
    remove_collider(h) {
        wasm.physicsworld_remove_collider(this.__wbg_ptr, h);
    }
    /**
     * @param {bigint} h
     * @param {boolean} remove_col
     */
    remove_rigid_body(h, remove_col) {
        wasm.physicsworld_remove_rigid_body(this.__wbg_ptr, h, remove_col);
    }
    /**
     * @param {number} x
     * @param {number} y
     ...
     */
    wake_up(h) {
        wasm.physicsworld_wake_up(this.__wbg_ptr, h);
    }
}
